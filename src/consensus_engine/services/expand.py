...
SYSTEM_INSTRUCTION = """You are a technical proposal assistant that expands brief ideas into detailed, structured proposals.
...
def expand_idea(idea_input: IdeaInput, settings: Settings) -> tuple[ExpandedProposal, dict[str, Any]]:
