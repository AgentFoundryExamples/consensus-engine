...
## src/consensus_engine/api/__init__.py
**Language:** Python  
**Role:** module-init  
**Role Justification:** module initialization file '__init__'  
**Summary:** Python module initialization (role: module-init)  
...
## src/consensus_engine/clients/openai_client.py
**Language:** Python  
**Role:** implementation  
**Role Justification:** general implementation file (default classification)  
**Summary:** Python core implementation  
...
## src/consensus_engine/schemas/validation.py
**Language:** Python  
**Role:** implementation  
**Role Justification:** general implementation file (default classification)  
**Summary:** Python core implementation  
...
## src/consensus_engine/services/aggregator.py
**Language:** Python  
**Role:** implementation  
**Role Justification:** general implementation file (default classification)  
**Summary:** Python core implementation  
...
## tests/unit/test_expand_service.py
**Language:** Python  
**Role:** test  
**Role Justification:** filename starts with 'test_'  
**Summary:** Python test file (role: test)  
